...
const MarkBillAsPaid = () => {
  ...
  const markBillAsPaid = async () => {
    ...
    const response = await fetch('https://apartment-v69r.onrender.com/markBillAsPaid', {
      method: 'POST',
  ...
  const viewBillLogs = async () => {
    const response = await fetch(`https://apartment-v69r.onrender.com/getBillLogs/${billStatus}`);
    const result = await response.json();
