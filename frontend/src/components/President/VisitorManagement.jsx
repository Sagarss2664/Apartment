...
const VisitorManagement = () => {
  ...
  const loadVisitors = async () => {
    try {
      ...
      let url = 'https://apartmentmanagementsystem-backend.onrender.com/api/visitors';
      if (filterDate) {
  ...
  const checkOut = async (id) => {
    try {
      const response = await fetch(`https://apartmentmanagementsystem-backend.onrender.com/api/visitors/checkout/${id}`, {
        method: 'PUT',
